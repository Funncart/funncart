...
const dummy = [
  ...
  {
    image: "/img/products/product-5.webp",
    name: "Brown Jacket",
    price: 1000,
    category: "clothes",
  },
  {
    image: "/img/products/product-6.webp",
    name: "Red jacket",
    price: 1000,
    category: "clothes",
  },
  {
    image: "/img/products/product-8.webp",
    name: "Earphone",
    price: 1000,
    category: "electronics",
  },
  {
    image: "/img/products/deal-1.webp",
    name: "Wallet",
    price: 1000,
    category: "watches",
  },
  {
    image: "/img/products/deal-2.webp",
    name: "Blue Shirt",
    price: 1000,
    category: "clothes",
  },
  {
    image: "/img/products/deal-4.webp",
    name: "Brown Shoes",
    price: 1000,
    category: "shoes",
  },
  {
    image: "/img/products/deal-3.webp",
    name: "Leather Belt",
    price: 1000,
    category: "watches",
  },
  {
    image: "/img/products/selling-6.webp",
    name: "Casual Shoes",
    price: 2500,
    category: "shoes",
  },
  ...
  return (
    ...
    <div className={style.wrapper}>
      {filteredData.length > 0 ? (
        filteredData.map((item) => <SingleProduct item={item} />)
      ) : (
        <NoProductFound />
      )}
    </div>
