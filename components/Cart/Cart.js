...
const style = {
  ...
  nav1: 'px-6 md:px-12 py-4 md:py-6 bg-stone-400 text-stone-100 font-bold tracking-wide w-[45%] flex items-center justify-center cursor-pointer hover:bg-stone-500 transition-all duration-[350ms] my-8 text-xs md:text-sm',
