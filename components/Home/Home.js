    ...
    <div className={style.wrapper}>
      <div className={style.main1}>
        <div className={style.left}>
          <Image src="/img/home.webp" alt="image of the home " width={700} height={700}/>
        </div>
        {/* right side */}
        <motion.div variants={variantsContainer}
          ...
          <h2 className={style.para} style={{ fontFamily: 'Poppins, sans-serif' }}>Our shop includes all kind of handcrafted products from your personal use to Gifts</h2>
          <Link href="/products">
