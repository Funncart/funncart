...
const style = {
    ...
    para:'text-stone-700 text-sm md:text-xs lg:text-sm my-3 font-bold text-center',
    ...
    return (
        <div className={style.wrapper}>
            <div className={style.featuresContainer}>
                <MdHighQuality className="text-stone-700 text-2xl lg:text-3xl"/>
                <p className={style.para}>BEST QUALITY</p>
            </div>
            <div className={style.featuresContainer}>
                <FaMoneyBillWave className="text-stone-700 text-2xl lg:text-3xl"/>
                <p className={style.para}>MONEY BACK GUARANTEE</p>
            </div>
            <div className={style.featuresContainer}>
                <BiSupport className="text-stone-700 text-2xl  lg:text-3xl"/>
