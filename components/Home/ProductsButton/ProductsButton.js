...
const style = {
    ...
    btn: 'text-lg md:text-lg rounded-full px-12 md:px-24 py-4 md:py-6 max-w-fit mx-auto bg-[#c8a165] text-stone-100 hover:bg-stone-500 transition duration-[300ms]',
}
