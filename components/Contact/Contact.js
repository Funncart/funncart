...
const style = {
  ...
  smallHeading:
    "border-b-2 border-green-900 text-2xl md:text-3xl max-w-fit mx-auto py-2 text-green-900 my-6",
  singleContactContainer: "flex items-center ",
  para: "text-green-800 text-sm md:text-sm my-2 md:my-4 hover:text-green-900",
};
const Contact = () => {
  return (
