...
const style = {
  ...
  heading: "text-2xl md:text-3xl text-green-900 my-6 font-bold smallDivider",
  reviewContainer: "flex flex-col justify-start",
  name: "text-xl md:text-2xl text-green-800 font-bold my-3",
  date: "text-sm md:text-sm text-stone-400 my-1",
  review: "text-sm md:text-md text-green-800",
};
